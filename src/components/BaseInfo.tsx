...
import {FaGoogleDrive, FiMail, ImAttachment, MdOutlineModeEditOutline} from 'react-icons/all';
import {Link} from 'react-router-dom';

const BaseInfo: FC<IbaseInfo> = ({type, path, title, background, avatarTxt, parent_name}) => {
    const {user}: any = useContext(User);
    return <div className={`base-info d-flex gap-3 ${type === 'ORG' && 'org_base-info'} ${type === 'PRJ' && 'prj_base-info'}`}>
        ...
        <div className="content-wrapper">
            ...
            {type === 'PRJ' && <div className="attachment-wrapper bg-silver mt-3">
