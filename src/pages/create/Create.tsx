...
const Create: FC = () => {
  ...
  return (
    <div className="create d-flex flex-column w-100 h-100">
      ...
      <div className="form-wrapper w-100 h-100">
        ...
        <form
          ...
          className="mt-4 pt-2 d-flex gap-4 flex-column mb-5"
        >
          <label className="w-100">
            <input
              ...
              required
            />
            <span className="text-silver thick">
              {type === "org" ? "Organization" : "Project"} name
            </span>
          </label>
          {type === "project" && (
            <>
